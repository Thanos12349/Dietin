...
const steps = [
  "FILL THE FORM OR YOU CAN SMS YOUR (NAME) SPACE (AGE) SPACE (CITY) AND SEND IT TO 9422799922",
        ...
        <div className="container position-relative" ref={sectionRef}>
          ...
          <div className="row">
            ...
            <div className="col-md-6 mt-4 mt-md-0">
              <div className="contact-card1 card shadow">
                <div className="card-body">
                  <form onSubmit={handleBookConsultation}>
                    <div className="row g-3">
                      ...
                      <div className="col-12">
                        <textarea name="message" value={formData.message} onChange={handleChange} className="form-control" rows="1" placeholder="Enter your Message"></textarea>
                      </div>
