...
const SaladMenu = () => {
    return (
        <>
            <section className="salad-menu-section py-2">
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-6 salad-text">
                            ...
                            <div className="salad-description">
                                Fresh Starts Here. Nourish Today, Thrive Tomorrow.<br />
                                Welcome to Dietin – your partner in health, taste, and convenience.
                                We believe healthy eating shouldn’t be complicated. With over <strong>25+</strong> curated menu options, crafted by experts and loved by <strong>10K+</strong> happy customers, we bring you meals that are not just wholesome, but full of flavor. <br />
                        ...
                        <div className="col-md-6 text-center salad-image-wrapper">
                            <div className="salad-circle">
                                ...
                                <img src="./images/essence.jpg" className="salad-spoon" alt="" />
                            </div>
